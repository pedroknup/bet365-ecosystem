...
export class user {
  ...
  @ManyToOne(
    () => user_status,
    (user_status: user_status) => user_status.users,
  ...
  @OneToMany(
    () => forgot_password,
    (forgot_password: forgot_password) => forgot_password.user,
    { onDelete: "NO ACTION", onUpdate: "NO ACTION" }
  )
  ...
  @OneToMany(
    () => user_external_login,
    (user_external_login: user_external_login) => user_external_login.user,
    { onDelete: "NO ACTION", onUpdate: "NO ACTION" }
  )
  ...
  @OneToMany(
    () => user_log,
    (user_log: user_log) => user_log.idUser,
    { onDelete: "NO ACTION", onUpdate: "NO ACTION" }
  )
  userLogs: user_log[];
}
